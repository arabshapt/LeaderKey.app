...
export const description = 'Arc kinesis'
...
export const manipulators = [
  ...
  ...map('f6', ['left_command', 'left_option', 'left_control', 'left_shift'])
    ...
    .condition(kinesis)
    .build(),
  // RCtrl+ROpt+RShift+LOpt+LCmd + p → Ctrl+tab (next tab, duplicate)
  ...map('p', ['right_control', 'right_option', 'right_shift', 'left_option', 'left_command'])
    .to('tab', 'left_control')
    .condition(arcApp)
    .condition(kinesis)
