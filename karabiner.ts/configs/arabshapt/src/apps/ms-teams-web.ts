...
// Rule 24: "Leader Key - MS Teams Web"
// 312 manipulators
export const description = "Leader Key - MS Teams Web"
...
export const manipulators: Manipulator[] = JSON.parse(String.raw`[
  {
    ...
    "conditions": [
      ...
      },
      {
        ...
        "bundle_identifiers": [
          "com.google.Chrome.app.cifhbcnohmdccbgoicgdjpfamggdegmo"
        ]
      },
      {
        "type": "frontmost_application_if",
    ...
    "to": [
      {
        "send_user_command": {
          "payload": {
            ...
            "type": "open",
            "background": true,
            "target": "kmtrigger://macro=GoToMSTeamsChat"
          }
        }
      },
      {
