...
// Rule 13: "Leader Key - Email Randstad"
// 196 manipulators
export const description = "Leader Key - Email Randstad"
...
export const manipulators: Manipulator[] = JSON.parse(String.raw`[
  {
    ...
    "conditions": [
      ...
      },
      {
        ...
        "bundle_identifiers": [
          "com.google.Chrome.dev.app.fmgjjmmmlfnkbppncabfkddbjimcfncm"
        ]
      },
      {
        "type": "frontmost_application_if",
