...
// Rule 23: "Leader Key - Google Chrome Dev"
// 261 manipulators
export const description = "Leader Key - Google Chrome Dev"
...
export const manipulators: Manipulator[] = JSON.parse(String.raw`[
  ...
  },
  {
    ...
    "to": [
      {
        "shell_command": "/opt/homebrew/bin/zsh -l -c 'osascript -e '\\''tell application \"Google Chrome Dev\" to return URL of active tab of front window'\\'' | pbcopy'"
      },
      {
        "send_user_command": {
          "payload": "deactivate"
  ...
  },
  {
    ...
    "to": [
      {
        "shell_command": "/opt/homebrew/bin/zsh -l -c 'osascript -e '\\''tell application \"Google Chrome\" to tell front window to make new tab with properties {URL:(URL of active tab)}'\\'''"
      },
      {
        "send_user_command": {
          "payload": "deactivate"
